...
- **[xmtp](https://xmtp.org/)** (backed by [a16z](https://a16z.com/)): developer [docs](https://docs.xmtp.org), protocol reliability and performance [testing](https://github.com/xmtp/xmtp-qa-tools)
